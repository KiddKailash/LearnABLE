...
/**
 * Responsive wrapper component that renders either the desktop
 * or mobile version of the NCCD reporting page based on screen size
 */
const ResponsiveNCCDReporting = () => {
  const theme = useTheme();
  // Use 'sm' breakpoint (600px) as the threshold
