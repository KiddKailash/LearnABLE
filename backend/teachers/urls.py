...
urlpatterns = [
    ...
    path('profile/notifications/', views.update_notification_preferences,
    ...
    path('profile/sessions/', views.get_active_sessions,
         name='get_active_sessions'),
    path('profile/sessions/terminate/',
         views.terminate_session, name='terminate_session'),
    path('profile/sessions/terminate-all/',
         views.terminate_all_sessions, name='terminate_all_sessions'),
    path('profile/export-data/', views.export_account_data,
         name='export_account_data'),
    path('profile/delete-account/', views.delete_account, name='delete_account'),
    path('profile/connect-google/', views.connect_google_account,
         name='connect_google_account'),
    path('profile/disconnect-google/', views.disconnect_google_account,
         name='disconnect_google_account'),
    path('profile/first-login/', views.update_first_login_status,
         name='update_first_login_status'),
]
